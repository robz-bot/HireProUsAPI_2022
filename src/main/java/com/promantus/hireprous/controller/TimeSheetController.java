...
public class TimeSheetController extends CommonController {
	...
	public List<TimeSheetDto> getTimeSheetByUserIdAndApproval(@PathVariable String userId,
			@PathVariable boolean isApproval, @RequestHeader(name = "lang", required = false) String lang) {
...
//	        resultDto.setMessage(e.getMessage());
	...
	public ResponseEntity<Map<String, Object>> getTaskAndHours(@PathVariable String userId,
			@RequestHeader(name = "lang", required = false) String lang) {
	...
	@GetMapping("/getBillable/{userId}")
	public ResponseEntity<Map<String, Double>> getBillable(@PathVariable String userId,
			@RequestHeader(name = "lang", required = false) String lang) {

		try {

			Map<String, Double> response = timeSheetService.getBillable(Long.parseLong(userId));
			return ResponseEntity.ok(response);
	...
	@GetMapping("/getApprovedHistory")
	public Map<String, List<TimeSheetDto>> getApprovedHistory(
			@RequestHeader(name = "lang", required = false) String lang) {
		try {

			return timeSheetService.getApprovedHistory();
	...
	@GetMapping("/getrejectedHistory")
	public Map<String, List<TimeSheetDto>> getRejectedHistory(
			@RequestHeader(name = "lang", required = false) String lang) {
		try {

			return timeSheetService.getRejectedHistory();

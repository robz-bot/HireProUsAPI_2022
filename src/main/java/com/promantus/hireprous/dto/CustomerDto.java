...
public class CustomerDto implements Serializable {
	...
	private List<RecruitmentRoleDto> recRoleDtoList;
	...
	/**
	 * @param recRoleNames the recRoleNames to set
	 */
	...
	/**
	 * @return the recRoleDtoList
	 */
	public List<RecruitmentRoleDto> getRecRoleDtoList() {
		return recRoleDtoList;
	}

	/**
	 * @param recRoleDtoList the recRoleDtoList to set
	 */
	public void setRecRoleDtoList(List<RecruitmentRoleDto> recRoleDtoList) {
		this.recRoleDtoList = recRoleDtoList;
	}
